...
Comparing with the base rate of 0.027, 0.035/0.027 = __1.28__, which means that cats have a __28%__ increased chance of being adopted at speed 0 over the base rate.
We can also see that cats are more likely to be adopted early than dogs. On the other hand more dogs are adopted at slower speed.  
...
Pets don’t have a name were adopted less frequently after 31-90 days, and more of them end up not being adopted after 100 days. Thus, pets with no name have a higher possibility of not being adopted. 

## Age VS Adoption Speed

Most pets in the training set are very young (0 - 12 months old). 
...
The overall health for the majority is good, number of pets with serious injuries is negligible. Now, Let's take a look at how does each feature do in terms of the adoption speed.
