...
train = pd.read_csv('./split/train_split.csv', engine='python')
test = pd.read_csv('./split/test_split.csv', engine='python')
sub = pd.read_csv('./split/sample_submission_split.csv')
...
submission_lcv.head()
submission_lcv.to_csv('./split/submission_lcv.csv', index=False)
...
submission_cat.head()
submission_cat.to_csv('./split/submission_cat.csv', index=False)
...
submission_lgb.head()
submission_lgb.to_csv('./split/submission_lgb.csv', index=False)
...
submission_xgb.head()
submission_xgb.to_csv('./split/submission_xgb.csv', index=False)
...
submission.head()
submission.to_csv('./split/submission.csv', index=False)